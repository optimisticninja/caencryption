...
bitset<N * 4> concat(const bitset<N>& b1, const bitset<N>& b2, const bitset<N>& b3, const bitset<N>& b4)
{
...
template<size_t N = 4>
bitset<N * 16> concat4(const bitset<N>& b1, const bitset<N>& b2, const bitset<N>& b3, const bitset<N>& b4,
